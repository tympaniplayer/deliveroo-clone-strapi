<template>
  <div>
    ...
    <div v-for="restaurant in filteredList" v-bind:key="restaurant" class="uk-card uk-card-default uk-grid-collapse uk-child-width-1-2@m uk-margin" uk-grid>
      ...
      <div class="uk-card-body">
        ...
        <router-link :to="{ name: 'restuarants-id', params: { id: restaurant.id }}" tag="a" class="uk-button uk-button-primary">
          See dishes
        </router-link>
      </div>
    </div>
